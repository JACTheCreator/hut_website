                ...
                <div class="collapse navbar-collapse" id="navbarText">
                    ...
                    <div class="navbar-text">
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item">
                                <asp:Panel id="linkSignInUp" runat="server" class="nav-link">
                                    <a href="/login">Login</a>
                                    &nbsp;<span style="color: blue;">|</span>&nbsp;
                                    <a href="/register">Register</a>
                                </asp:Panel>

                                <asp:Panel id="linkUserInfo" runat="server" class="nav-link">
                        ...
                        <ItemTemplate>
                            <div class="card text-center" style="width: 18rem;">
                                ...
                                <div class="card-footer" style="padding: 0; margin: 0; background-color: #427597">
                                    <asp:Button style="max-width: 100%; width: 100%" Text="Add to cart" type="button" class="btn btn-primary"  runat="server"/>
                                    <asp:Button ID="btnDel"  runat="server" style="max-width: 100%; width: 100%; background-color: red" Text="Delete" type="button" class="btn btn-primary" OnCommand="DeleteProduct" CommandName='<%# DataBinder.Eval(Container.DataItem, "Id") %>'/>
                                </div>
                            </div>
                        </ItemTemplate>
                    </asp:ListView>
